...
module.exports = function(projectDir, appDir, ext) {
  var app, assetFile, assets, chainware, config, dir, express, init, initialized, injector, load, loaded, mongoose, name, packets, pkg, publicDir, relativeAppDir, relativeProjectDir, routed, router, swig, _ref, _ref1, _ref2;
  ...
  glob("" + appDir + "/*/", {
    ...
    for (_i = 0, _len = files.length; _i < _len; _i++) {
      file = files[_i];
      _results.push(packets.push(path.basename(file)));
    }
    return _results;
  });
  ...
  loaded = false;
  load = function() {
    var connected, connection, emitter, engine, globDir, resolve, views;
    if (loaded) {
      return;
    }
    loaded = true;
