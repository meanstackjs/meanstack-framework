...
module.exports = function(projectdir, appdir, appext, config, built) {
  var app, appname, assetfile, assets, chainware, connection, controllers, defaults, dir, engine, globdir, k, locals, mean, models, n, obj, overrides, p, pkg, plugin, plugins, publicdir, regex, relappdir, relprojectdir, router, store, vhost, vhosts, views, _i, _j, _len, _len1, _ref;
